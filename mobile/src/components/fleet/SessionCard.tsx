// DESIGN_SYSTEM.md §6 SessionCard (fleet): StatusDot + title + NEEDS-YOU/worktree badges;
// line2 cwd tail (mono, head-ellipsized) · model · relative time; line3 ContextGauge + cost.
// Swipe (native, react-native-gesture-handler) / long-press / trailing `…` all open the SAME
...
const styles = StyleSheet.create({
  wrap: { position: "relative", marginBottom: space.space8, borderRadius: radii.radius12, overflow: "hidden" },
  ...
  title: { flex: 1 },
  row2: { flexDirection: "row", alignItems: "center", gap: space.space8, marginTop: space.space8 },
  cwd: { flex: 1 },
  row3: { flexDirection: "row", alignItems: "center", gap: space.space12, marginTop: space.space8 },
  gauge: { flex: 1 },
