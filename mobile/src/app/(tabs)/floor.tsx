...
const styles = StyleSheet.create({ header: { flexDirection: "row", alignItems: "baseline", gap: space.space8, paddingVertical: space.space12 }, mark: { marginRight: -space.space4 }, list: { paddingBottom: space.space24 }, tileWrap: { flex: 1, padding: space.space4 }, loading: { flex: 1, alignItems: "center", justifyContent: "center", gap: space.space12 } });
