...
use crate::app_remote::{DiffFileSnapshot, TranscriptKind};
...
pub struct App {
    ...
    pub(crate) subagents: Vec<SubRow>,
    ...
    pub(crate) tasks: Vec<forge_types::TodoItem>,
    ...
    pub(crate) pending_diff: Option<DiffFileSnapshot>,
