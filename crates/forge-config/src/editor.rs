...
pub fn setting_help(path: &str) -> Option<&'static str> {
    Some(match path {
        ...
        "mesh.classifier_model" => "First model the llm classifier calls. Default: groq::openai/gpt-oss-20b. Set an available capable model to override it; fixed backups are tried if it fails.",
