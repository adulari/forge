...
pub use paths::{
    claude_dir, codex_dir, config_dir, cursor_dir, data_dir, home_dir,
    mark_project_auto_setup_attempted, project_auto_setup_attempted, project_initialization,
...
pub(crate) use provider_registry::{
    azure_registry, custom_provider_registry, PROVIDER_ENV_VARS, SEARCH_ENV_VARS,
};

#[cfg(test)]
use editor::test_support::{
    coerce_value, flatten_value, priority_rank, remove_dotted, set_dotted, write_subscriptions_at,
};
#[cfg(test)]
