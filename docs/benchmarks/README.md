...
46.65% fewer cache-adjusted tokens. Honest review excluded the original Claude result because its
base tree tracked generated bytecode; a correct-tree replacement stopped at zero model tokens after
local OAuth expired. The accepted Forge and Codex workspaces also passed a free follow-up replay
covering 100 deterministically alternating reserve/cancel operations and cancellation-write
rollback. The
