...
| — | Ctrl-Home | Full-screen: jump to the most recent user message above the view; again = the one before (the "↑ Previous message" bar at the top does the same on click) |
